...
public class testPreferredSize {
	
	private JFrame window;
	
	public testPreferredSize(AbstractLinearSolver solver){
		window = new JFrame();
	...
	public void testWidth() {
		assertEquals("Incorrect Width", 300, window.getContentPane().getWidth());
	}
	
	@Test
	public void testHeight() {
		assertEquals("Incorrect Height", 300, window.getContentPane().getHeight());
	}
